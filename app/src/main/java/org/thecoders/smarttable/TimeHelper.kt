...
import org.thecoders.smarttable.ui.Fragment_Settings
...
class TimeHelper {
    ...
    companion object {
        ...
        fun calcTimingById(context: Context, id: Int) : String {
            ...
            val startTime = TimeHelper.addTime(startOfDay, (lessonDuration.toInt() * id).toString())
            val endTime = TimeHelper.addTime(startTime, lessonDuration)

            return TimeHelper.buildTiming(listOf(startTime, endTime))
        }
